			...
			<div id="fh5co-main">
				<div class="container">
					<?php
                        ...
                        if(isset($_GET['tag'])){
                            $categoryname = $_GET['tag'];
                            $query1 = "SELECT * FROM post WHERE category = '$categoryname'";
						...
						<div id="fh5co-board" class="col-lg-3">
                            <div class="item row">
                                <div class="animate-box card">   
                                    <?php echo '<img src="data:image;base64,'.base64_encode($row1['file']).'" >' ; ?>                    
                                </div><!--end card-body-->
								<div class="fh5co-desc">
									<div style="float:left">
										<h2 class="card-title title"><?php echo $row1['title'] ?></h2>
									</div>
									<div class="more" style="float:right">
										<a href="download.php?download=<?php echo $row1['title']?>">
