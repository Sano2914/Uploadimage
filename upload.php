...
<head>
	...
	<title><?php echo $set['sitetitle'] ?> - Upload</title>
...
<body>
    ...
    <div class="container">
    	<div class="row">
    		...
    		<div class="col-md-6">
    			<article class="card">
                    <h2 class="text-center mt-5 mb-3 display-5">Upload</h2>
    			<div class="card-body font-15">
    				...
    				<form action=" " method="POST" enctype="multipart/form-data">                        
                        <div class="form-group row">
							...
							?>
                            <label class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center">Title</label>
                            <div class="col-lg-4 col-xl-8">
                                <input type="text" class="form-control font-15" id="title" name="title"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center">Categories</label>
                            <div class="col-lg-4 col-xl-8">
								<select class="form-control font-13" id="category" name="category" required>
                        ...
                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center">Sub Categories</label>
                            <div class="col-lg-4 col-xl-8">
							<select class="form-control font-13" id="subcategory" name="subcategory" required>
									<?php while($row2 = mysqli_fetch_array($res1)):;?>
                        ...
                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center">File Upload</label>
                            <div class="col-lg-4 col-xl-8">
                            <input type="file" id="file" name="image" class="dropify font-15" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center">URL</label>
                            <div class="col-lg-4 col-xl-8">
                                <input type="text" class="form-control font-15" id="url" name="url"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center">Meta Keyword</label>
                            <div class="col-lg-4 col-xl-8">
                                <input type="text" class="form-control font-15" id="metakey" name="metakey"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-9 col-xl-8 offset-lg-5">
                                <button class="btn btn-primary font-15" id="submit" name="submit" >Submit</button>
                            </div>
                        </div>
                    </form>
                    <ul>
    					<li>Upload transparent background PNG</li>
    					<li>Supported Image: .png(with alpha channel)</li>
    					<li>Max Filesize: 10Mb, Min size:128x128px</li>
    				</ul>
    			</div>
    			</article>
    		</div>
